...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250111150211_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.DynamicFieldType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9f99c974-94cc-4444-bf63-26fb99c6d56f"),
                            Title = "string"
                        },
                        new
                        {
                            Id = new Guid("f420022e-ebb6-4f49-ac50-80a3c281f91b"),
                            Title = "number"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.EventSignupWindow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Domain.Entities.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1f103d44-5eb4-4667-bc6c-b05091c35267"),
                        ...
                        new
                        {
                            Id = new Guid("86f62fae-6821-48ca-acd0-1a29ab6d68a6"),
                        ...
                        new
                        {
                            Id = new Guid("667f7e21-aeb8-4c3b-8d2e-f05769784643"),
                            CanEditOthersEvents = true,
                            IsAdmin = false,
                            Title = "Moderator"
                        });
            ...
            modelBuilder.Entity("Domain.Entities.EventSignupEntry", b =>
                {
                    b.HasOne("Domain.Entities.EventSignupWindow", "SignupWindow")
                        .WithMany()
